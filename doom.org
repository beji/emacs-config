...
(doom! :input
       ...
       (lsp +eglot)
       (:if IS-MAC lsp)         ; infrastructure as code
       (:if IS-LINUX (lsp +eglot))
       ;;(lsp +eglot)
       ...
       (:if IS-MAC (terraform +lsp))         ; infrastructure as code
       (:if IS-LINUX terraform)
       ...
       ;;idris             ;
       (:if IS-MAC (json +lsp +tree-sitter))              ; At least it ain't XML
       (:if IS-LINUX json +tree-sitter)
       (:if IS-MAC (java +lsp +tree-sitter))
